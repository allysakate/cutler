...
# from third_party.TokenCut.unsupervised_saliency_detection.bilateral_solver import
# BilateralSolver, BilateralGrid
...
def maskcut(img_path, backbone, patch_size, tau, N=1, fixed_size=480, cpu=False):
    ...
    _, bipartition, eigvec = maskcut_forward(
        feat, [feat_h, feat_w], [patch_size, patch_size], [h, w], tau, N=N, cpu=cpu
    )
